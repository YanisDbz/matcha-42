...
export const Filter = ({
  ...
  return (
    <>
      <p> Sort by </p>
      <Col className="sort">
        <Button variant="outlined" color="secondary" onClick={SortByAge}>
          AGE
          <ChevronExpand className="sort-icon" />
        </Button>
        <Button variant="outlined" color="secondary" onClick={SortByDistance}>
          KM
          <ChevronExpand className="sort-icon" />
        </Button>
        <Button variant="outlined" color="secondary" onClick={SortByFame}>
          FAME
          <ChevronExpand className="sort-icon" />
        </Button>
        <Button variant="outlined" color="secondary" onClick={SortByInterest}>
          TAGS
          <ChevronExpand className="sort-icon" />
        </Button>
      </Col>
